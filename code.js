...
function _crear_cajas(){
    ...
    setTimeout(function(){
            ...
            if (r < 4){
                ...
                $(this).click(function(){
                    ...
                    if (puntos == puntos_creados && puntos != 0){
                        alert('WOW! You WON \n It seems you found all your relevant Data Points in your system. \n Learn more about our "Digitalization Strategy Workshop" on our Bosch Connect Site.');
                        _reset();
                    }                    
                });
            };
        ...
        $('.contiene_juego .b,.contiene_juego .b1,.contiene_juego .b2')
          .hover(function(){
              alert('GAME OVER!\nIt seems you need some help dedecting your Data Points.\nLearn more abour our Digitalization Strategy Workshop on our Bosch Connect Community\n-- Points achived: '+puntos+'');
              _reset();
        });      
